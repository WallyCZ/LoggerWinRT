...
void Wally::Logger::OutStringW(const wchar_t * str)
{
	LogTargetManager::WriteToAllTargets(str);
}

void Wally::Logger::WritePrefixW(Wally::LoggerLevel level, std::wstring& tmp)
{
	...
	switch (level)
	{
	case Wally::LoggerLevel::LOGGER_LEVEL_TRACE:
		tmp.append(L" [T] "); break;
	case Wally::LoggerLevel::LOGGER_LEVEL_DEBUG:
		tmp.append(L" [D] "); break;
	case Wally::LoggerLevel::LOGGER_LEVEL_INFO:
		tmp.append(L" [I] "); break;
	case Wally::LoggerLevel::LOGGER_LEVEL_WARN:
		tmp.append(L" [W] "); break;
	case Wally::LoggerLevel::LOGGER_LEVEL_ERROR:
		tmp.append(L" [E] "); break;
	case Wally::LoggerLevel::LOGGER_LEVEL_FATAL:
...
void Wally::Logger::WriteLine(Wally::LoggerLevel level, const std::wstring & str)
{
	std::wstring strOut;
...
void Wally::Logger::WriteLine(Wally::LoggerLevel level, const std::string & str)
{
	std::wstring strOut;
	WritePrefixW(level, strOut);
...
void Wally::Logger::WriteLine(Wally::LoggerLevel level, const char * str)
{
	std::wstring strOut;
...
DLLEXPORT void Wally::Logger::WriteLineFormat(Wally::LoggerLevel level, const std::wstring & format, va_list args)
{
...
DLLEXPORT void Wally::Logger::WriteLineFormat(Wally::LoggerLevel level, const std::wstring & format, ...)
{
	va_list args;
