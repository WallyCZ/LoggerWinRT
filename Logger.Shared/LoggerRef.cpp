...
void Wally::Utils::Logger::WriteLine(Wally::Utils::LoggerLevel level, Platform::String ^ str)
{
...
void Wally::Utils::Logger::WriteLine(Wally::Utils::LoggerLevel level, Platform::String ^ str, Windows::Foundation::Collections::IVector<Platform::Object^>^ params)
{
	std::wstring strW(str->Begin());
